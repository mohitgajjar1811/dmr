        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 overflow-y-auto py-4">
                <ul class="space-y-1 px-2">
                    ...
                    <li class="pt-4 pb-2 px-4 text-xs font-bold text-gray-500 uppercase tracking-widest">Leads & Contact</li>
                    <li>
                        <a href="{{ route('admin.enquiry.list') }}" class="flex items-center gap-3 px-4 py-3 rounded hover:bg-gray-800 transition {{ request()->routeIs('admin.enquiry.*') ? 'bg-gray-800 text-white' : 'text-gray-300' }}">
                            <i class="fas fa-envelope w-5 text-center"></i>
                            <span class="font-medium">Enquiries</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.newsletter.list') }}" class="flex items-center gap-3 px-4 py-3 rounded hover:bg-gray-800 transition {{ request()->routeIs('admin.newsletter.*') ? 'bg-gray-800 text-white' : 'text-gray-300' }}">
                            <i class="fas fa-paper-plane w-5 text-center"></i>
                            <span class="font-medium">Newsletter</span>
                        </a>
                    </li>

                    <li class="pt-4 pb-2 px-4 text-xs font-bold text-gray-500 uppercase tracking-widest">Frontend Content</li>
                    <li>
                        <a href="{{ route('admin.banner.list') }}" class="flex items-center gap-3 px-4 py-3 rounded hover:bg-gray-800 transition {{ request()->routeIs('admin.banner.*') ? 'bg-gray-800 text-white' : 'text-gray-300' }}">
                            <i class="fas fa-images w-5 text-center"></i>
                            <span class="font-medium">Banners</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.feature.list') }}" class="flex items-center gap-3 px-4 py-3 rounded hover:bg-gray-800 transition {{ request()->routeIs('admin.feature.*') ? 'bg-gray-800 text-white' : 'text-gray-300' }}">
                            <i class="fas fa-star w-5 text-center"></i>
                            <span class="font-medium">Home Features</span>
                        </a>
                    </li>

                    <li class="pt-4 pb-2 px-4 text-xs font-bold text-gray-500 uppercase tracking-widest">Configuration</li>
                    <li>
                        <a href="{{ route('admin.settings.site') }}" class="flex items-center gap-3 px-4 py-3 rounded hover:bg-gray-800 transition {{ request()->routeIs('admin.settings.site') ? 'bg-gray-800 text-white' : 'text-gray-300' }}">
                            <i class="fas fa-cogs w-5 text-center"></i>
                            <span class="font-medium">Site Settings</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.settings.smtp') }}" class="flex items-center gap-3 px-4 py-3 rounded hover:bg-gray-800 transition {{ request()->routeIs('admin.settings.smtp') ? 'bg-gray-800 text-white' : 'text-gray-300' }}">
