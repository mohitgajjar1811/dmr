                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="5"
                                ...
                                class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all">{{ $product->description }}</textarea>
                        </div>
