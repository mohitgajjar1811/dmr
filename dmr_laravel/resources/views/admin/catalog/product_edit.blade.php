...
@section('title', 'Edit Product | DMR Admin')
...
@section('content')
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-black text-gray-900 uppercase tracking-tight">Edit <span
                class="text-red-600">Product</span></h1>
        <p class="text-gray-500 text-sm">Update product details and media.</p>
    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="5"
                                ...
                                class="rich-editor w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all">{{ $product->description }}</textarea>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            @if($product->main_image)
                                <div class="mb-2 w-32 h-32 rounded overflow-hidden border border-gray-200">
                        ...
                        <div>
                            ...
                            @if($product->pdf_brochure)
                                <div class="mb-2 text-xs text-blue-600 font-bold">
                                    <a href="{{ asset('storage/' . $product->pdf_brochure) }}" target="_blank"><i
                                            class="fas fa-file-pdf"></i> View Current PDF</a>
                                </div>
                            @endif
