...
@section('title', 'Add Banner | DMR Admin')
...
<div class="mb-8">
    ...
    <h1 class="text-2xl font-black text-gray-900 uppercase tracking-tight">Add New <span class="text-red-600">Banner</span></h1>
    <p class="text-gray-500 text-sm">Create a new carousel slide for the homepage.</p>
</div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <div>
                    <label class="block text-xs font-bold uppercase tracking-widest text-gray-700 mb-2">Upload Image (Recommended: 1920x800)</label>
                    <input type="file" name="image" required accept="image/*" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-bold file:bg-red-50 file:text-red-700 hover:file:bg-red-100 transition-all">
                </div>
            </div>
        </div>
