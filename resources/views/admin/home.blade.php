...
@yield('title', 'Overview | Virja Admin')
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 uppercase">
    ...
    <a href="{{ route('admin.brand.list') }}"
        ...
        <div>
            <p class="text-gray-500 text-sm font-medium">Brands</p>
            <p class="text-2xl font-bold text-gray-800">{{ $stats['total_brands'] }}</p>
        </div>
    </a>
</div>
...
<div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <a href="#" class="block p-4 border border-dashed border-gray-300 rounded hover:border-blue-500 hover:bg-blue-50 transition text-center group">
        ...
        <a href="#" class="block p-4 border border-dashed border-gray-300 rounded hover:border-purple-500 hover:bg-purple-50 transition text-center group">
            <i class="fas fa-tag text-gray-400 group-hover:text-purple-500 text-2xl mb-2"></i>
            <h3 class="font-medium text-gray-700 group-hover:text-purple-600">Add New Brand</h3>
        </a>
    </div>
</div>
@endsection
